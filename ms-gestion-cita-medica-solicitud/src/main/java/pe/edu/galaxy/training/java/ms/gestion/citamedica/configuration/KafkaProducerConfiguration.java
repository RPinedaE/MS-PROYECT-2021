...
public class KafkaProducerConfiguration {
	...
	@Bean
	public ProducerFactory<String, SolicitudCitaDTO> citaProducerFactory() { 
	...
	@Bean
	public KafkaTemplate<String, SolicitudCitaDTO> citaKafkaTemplate() {
	
		KafkaTemplate<String, SolicitudCitaDTO> kafkaTemplate = new KafkaTemplate<>(citaProducerFactory());

		//Mas que listener es un Command
		kafkaTemplate.setProducerListener(new ProducerListener<String, SolicitudCitaDTO>() {

			@Override
			public void onSuccess(ProducerRecord<String, SolicitudCitaDTO> producerRecord, RecordMetadata recordMetadata) {
			...
			@Override
			public void onError(ProducerRecord<String, SolicitudCitaDTO> producerRecord, RecordMetadata recordMetadata,
					Exception exception) {

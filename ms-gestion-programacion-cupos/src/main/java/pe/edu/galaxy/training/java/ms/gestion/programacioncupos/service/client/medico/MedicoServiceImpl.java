...
import pe.edu.galaxy.training.java.ms.gestion.programacioncupos.service.client.planilla.PlanillaService;
import pe.edu.galaxy.training.java.ms.gestion.programacioncupos.service.client.provext.ProvExternoService;
...
public class MedicoServiceImpl implements MedicoService{
	...
	public MedicoDTO findById(Long id) throws ClientException { // --> Plan A
		...
		return circuitBreaker.run(() -> {
			log.info("--> MedicoDTO : Ejecutando Plan A");
	...
	public MedicoDTO getMedicoDTOPlanB(Long id) { // --> Plan B
		return circuitBreaker.run(() -> {
			log.info("--> MedicoDTO : Ejecutando Plan B");
			try {
	...
	public MedicoDTO getMedicoDTOPlanC(Long id) { // --> Plan C
		return circuitBreaker.run(() -> {
			log.info("--> MedicoDTO : Ejecutando Plan C");
			try { 
	...
	public MedicoDTO getMedicoDTODefault(Long id) {
		log.info("--> MedicoDTO : Ejecutando Default...");
		return null;
	}

...
public class PlanillaServiceImpl implements PlanillaService{
	...
	private String url="ms-gestion-planilla";
	
	public PlanillaServiceImpl(DiscoveryClient discoveryClient, RestTemplate restTemplate) {
	...
	public PersonalDTO getPersonalMedico(Long idMedico) throws ClientException {
        ResponseEntity<PersonalDTO> respEntPersonalDTO=restTemplate.getForEntity(this.getURI()+"/v1/personal/medico/"+idMedico, PersonalDTO.class);
